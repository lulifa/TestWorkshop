...
[Authorize(TestWorkshopPermissions.OrganizationUnits.Default)]
public class SystemOrganizationUnitAppService : TestWorkshopAppService, ISystemOrganizationUnitAppService
{
    ...
    [Authorize(TestWorkshopPermissions.OrganizationUnits.Update)]
    ...
    [Authorize(TestWorkshopPermissions.OrganizationUnits.ManageRoles)]
    ...
    [Authorize(TestWorkshopPermissions.OrganizationUnits.ManageUsers)]
    ...
    [Authorize(TestWorkshopPermissions.OrganizationUnits.Create)]
    ...
    [Authorize(TestWorkshopPermissions.OrganizationUnits.Delete)]
