...
[Authorize(TestWorkshopPermissions.DataDictionary.Default)]
public class DataAppService : TestWorkshopAppService, IDataAppService
{
    ...
    [Authorize(TestWorkshopPermissions.DataDictionary.Create)]
    ...
    [Authorize(TestWorkshopPermissions.DataDictionary.Delete)]
    ...
    [Authorize(TestWorkshopPermissions.DataDictionary.Move)]
    ...
    [Authorize(TestWorkshopPermissions.DataDictionary.Update)]
    ...
    [Authorize(TestWorkshopPermissions.DataDictionary.ManageItems)]
