...
[Authorize(TestWorkshopPermissions.Layout.Default)]
public class LayoutAppService : TestWorkshopAppService, ILayoutAppService
{
    ...
    [Authorize(TestWorkshopPermissions.Layout.Create)]
    ...
    [Authorize(TestWorkshopPermissions.Layout.Delete)]
    ...
    [Authorize(TestWorkshopPermissions.Layout.Update)]
