...
public class EfCoreDataRepository : EfCoreRepository<TestWorkshopDbContext, Data, Guid>, IDataRepository
{
    public EfCoreDataRepository(
        IDbContextProvider<TestWorkshopDbContext> dbContextProvider) : base(dbContextProvider)
    {
    }
