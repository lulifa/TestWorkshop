...
public class EfCoreLayoutRepository : EfCoreRepository<TestWorkshopDbContext, Layout, Guid>, ILayoutRepository
{
    public EfCoreLayoutRepository(IDbContextProvider<TestWorkshopDbContext> dbContextProvider)
