...
namespace TestWorkshop.Migrations
{
    ...
    [Migration("20260826054953_EditWorkshopDevice")]
    partial class EditWorkshopDevice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestWorkshop.Data", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppDatas", (string)null);
                });

            modelBuilder.Entity("TestWorkshop.DataItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TestWorkshop.Layout", b =>
                {
                    ...
                    b.ToTable("AppLayouts", (string)null);
                });

            modelBuilder.Entity("TestWorkshop.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TestWorkshop.UserFavoriteMenu", b =>
                {
                    ...
                    b.ToTable("AppUserFavoriteMenus", (string)null);
                });

            modelBuilder.Entity("TestWorkshop.UserMenu", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TestWorkshop.DataItem", b =>
                {
                    b.HasOne("TestWorkshop.Data", null)
                        .WithMany("Items")
