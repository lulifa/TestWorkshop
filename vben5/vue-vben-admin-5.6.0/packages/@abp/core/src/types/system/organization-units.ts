...
interface OrganizationUnitDto
  extends AuditedEntityDto<string>, IHasExtraProperties {
  /** 编号 */
  code: string;
  /** 显示名称 */
  displayName: string;
...
/** 组织机构创建对象 */
interface OrganizationUnitCreateDto extends IHasExtraProperties {
  /** 显示名称 */
  displayName: string;
  /** 父节点标识 */
  parentId?: string;
...
/** 组织机构变更对象 */
interface OrganizationUnitUpdateDto extends IHasExtraProperties {
  /** 显示名称 */
  displayName: string;
}
